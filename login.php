...
<img src="photo/auto3.PNG" style="margin-left:20px; margin-top:40px"></img>
...
print<<<eof
	...
	<form method='post'>
		<table>
			<tr><td>Login</td><td><input type="text" name="loginadmin"> </input></td></tr>
			<tr><td>Password</td><td><input type="password" name="passwordadmin"> </input></td></tr>
...
//Recuperation des donnees transmises pour ADMIN
	...
	if (isset($_POST["entreradmin"]))
	{
		...
		//3--Requete sql
		$reqadmin=mysqli_query($connect,"select * from administration where login='$loginadmin' and password='$passwordadmin'");
